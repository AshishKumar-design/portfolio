    ...
    (function () {
      ...
      n(
        ...
        e(h)
          .val()
          .match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/)
          ? (e(h).removeClass("is-invalid"), (a = !0))
          : (e(h).addClass("is-invalid"), (a = !1));
      return a;
    })() &&
      jQuery
        .ajax({
...
// Add click event to trigger animation and file download
downloadButton.addEventListener("click", function (e) {
  ...
  // Simulate download and animation
  setTimeout(() => {
    this.classList.remove("shake", "clicked");
  ...
  }, 600); // Time should match the animation duration
});
